<%-- 
    Document   : newsPost
    Created on : Oct 12, 2018, 9:30:20 AM
    Author     : admin
--%>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                <div class="row mb-3 align-items-center">
                    <div class="col-md-1">
                        <strong for="np-title" class="card-title mb-1">Tiêu đề</strong>
                    </div>
                    <div class="col-md-11">
                        <input id="np-title" name="np-title" type="text" class="form-control" aria-required="true" aria-invalid="false">
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Thông tin cơ bản</strong>
                            </div>
                            <!-- Credit Card -->
                            <div id="pay-invoice">
                                <div class="card-body">
                                    <form action="" method="post" novalidate="novalidate">
                                        ...
                                        <div class="form-group">
                                            <label for="fr-roomNumber" class="control-label mb-1">Số phòng</label>
                                            <input id="fr-roomNumber" name="fr-roomNumber" type="number" class="form-control" aria-required="true" aria-invalid="false">
                                        </div>
                            ...
                            <div id="pay-invoice">
                                <div class="card-body">
                                    <form action="" method="post" novalidate="novalidate">
                                        ...
                                        <div class="form-group has-success">
                                            <label for="fr-Street" class="control-label mb-1">Đường vào</label>
                                        ...
                                        <div class="form-group has-success">
                                            ...
                                            <input id="fr-price" name="fr-price" type="number" class="form-control" data-val="true" data-val-required="Please enter the birthday" autocomplete="cc-name" aria-required="true" aria-invalid="false" aria-describedby="cc-name-error">
                                        </div>
                                        <div class="form-group has-success">
                                            <div class="row">
                                                <div class="col-md-6">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p>Mô tả chi tiết về phòng của bạn. Mô tả chi tiết, đầy đủ sẽ đạt hiệu quả cao hơn</p>
                            </div>
                        </div> <!-- .card -->
                    </div>
                    <!-- /mô tả -->
                            ...
                            <div id="pay-invoice">
                                ...
                                <div class="card-footer d-flex justify-content-end">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-sm ml-2">
                                        <i class="fa fa-check"></i> Đăng tin
                                    </button>
                                </div>
                            </div>
                        </div> <!-- .card -->
