<%-- 
    ...
    Created on : Oct 12, 2018, 9:45:20 AM
    Author     : admin
--%>
            ...
            <nav class="navbar navbar-expand-sm navbar-default">
                ...
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li class="active">
                            <a href="index.jsp
                               "> <i class="menu-icon fa fa-dashboard"></i>Tổng quan</a>
                        </li>
                        <!-- information -->
                        <h3 class="menu-title">Quản lý thông tin cá nhân</h3><!-- /.menu-title -->
                        <li >
                            <a href="information.jsp">
                                <i class="menu-icon fa fa-user"></i>Thay đổi thông tin</a>
                        </li>
                        <li>
                            <a href="resetPassword.jsp
                               "><i class="menu-icon fa fa-unlock-alt"></i>Đổi mật khẩu</a>
                        </li>
                        <!--  -->
                        ...
                        <li>
                            <a href="newsPost.jsp
                               "> <i class="menu-icon fa fa-edit"></i>Đăng tin cho thuê</a>
                        </li>
                        <li>
                            <a href="managerPost.jsp
                               "> <i class="menu-icon fa fa-folder"></i>Quản lý tin cho thuê</a>
                        </li>
                        <!--  -->
                        <h3 class="menu-title">Quản lý TT phòng trọ</h3><!-- /.menu-title -->

                        <li>
                            <a href="newsMotel.jsp
                               "> <i class="menu-icon fa fa-edit"></i>Thêm mới phòng trọ</a>
                        </li>
                        <li>
                            <a href="managerMotel.jsp
                               "> <i class="menu-icon fa fa-folder"></i>Quản lý phòng trọ</a>
                        </li>
                        <!--  -->
                        <h3 class="menu-title">Quản lý người dùng</h3><!-- /.menu-title -->

                        <li>
                            <a href="managerAccount.jsp
                               "> <i class="menu-icon fa fa-legal"></i>Quản lý quyền</a>
                        </li>
                        <li>
                            <a href="managerUser.jsp
                               "> <i class="menu-icon fa fa-users"></i>Quản lý người dùng</a>
                        </li>
                    </ul>
                </div><!-- /.navbar-collapse -->
            </nav>
                ...
                <div class="col-sm-6">
                    <div class="page-header float-left">
                        <div class="page-title">
                            <h1>Tổng quan(trang tổng quan này nhóm em triển khai sau)</h1>
                        </div>
                    </div>
                </div>
            </div>
